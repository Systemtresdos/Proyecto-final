            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div class="p-6 bg-gradient-to-r from-[#D1E7DD] to-[#D1E7DD]/70 border-b border-[#D1E7DD]">
                    <div class="flex items-center space-x-3">
                        <div>
                            <h3 class="text-2xl font-bold text-[#2B2B2B]">Editar Proveedor</h3>
                            <p class="text-sm text-[#A1A1A1] mt-1">Editando: <span
                                    class="font-medium text-[#166534]">{{ $proveedors->nombre }}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8">
                    <form action="{{ route('proveedores.update', $proveedors->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre" id="nombre"
                                    ...
                                    value="{{ old('nombre', $proveedors->nombre) }}" required
                            ...
                            <div>
                                ...
                                <input type="text" name="nombre_contacto" id="nombre_contacto"
                                    class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm 
                                              focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534]
                                              transition duration-200 placeholder-[#A1A1A1]/70"
                                    value="{{ old('nombre_contacto', $proveedors->nombre_contacto) }}" required
                        ...
                        <div>
                            ...
                            <input type="tel" name="telefono" id="telefono"
                                class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm 
                                          focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534]
                                          transition duration-200 placeholder-[#A1A1A1]/70"
                                value="{{ old('telefono', $proveedors->telefono) }}" required
                        ...
                        <div>
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm 
                                          focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534]
                                          transition duration-200 placeholder-[#A1A1A1]/70"
                                placeholder="Información adicional">{{ old('descripcion', $proveedors->descripcion) }}</textarea>
                        </div>
                        <!-- Botones -->
