...
<head>
    ...
    <title>Pandora Cochabamba</title>
...
<body class="bg-[#F5F5F5] text-[#2B2B2B] min-h-screen">
    <div class="flex flex-col lg:flex-row w-full min-h-screen">

        <!-- Sección izquierda con imagen de fondo -->
        <div class="hidden lg:block lg:w-1/2 relative overflow-hidden">
            <div class="absolute inset-0 bg-[#166534] opacity-90 z-0"></div>
            <img src="https://images.unsplash.com/photo-1599643478518-a784e5dc4c8f?ixlib=rb-4.0.3&auto=format&fit=crop&w=1587&q=80"
                alt="Joyas elegantes" class="absolute inset-0 w-full h-full object-cover z-0 mix-blend-multiply" />
            <div class="absolute inset-0 flex items-center justify-center p-12 z-10">
                <div
                    class="text-center bg-white/10 p-12 rounded-2xl backdrop-blur-sm shadow-lg max-w-lg border border-[#D1E7DD]/20">
                    <h1 class="text-3xl font-light text-[#D1E7DD] mb-2">Bienvenido a</h1>
                    <h2 class="text-5xl font-serif font-semibold text-white mb-4 tracking-wide">Joyeria Pandora
                        Cochabamba</h2>
                    <div class="w-20 h-[2px] bg-[#D1E7DD] mx-auto mb-6"></div>
                    <p class="text-md text-[#D1E7DD]/90 leading-relaxed">
                        Accede a tu cuenta para gestionar el sistema de ventas e inventario.
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center px-6 py-12 bg-[#F5F5F5]">
            <form action="{{ route('login') }}" method="POST" class="w-full max-w-md space-y-6">
                @csrf
                <div class="flex flex-col items-center mb-4">
                    <img class="w-64 h-40 object-fil"
                        src="https://brandlogos.net/wp-content/uploads/2021/12/pandora-brandlogo.net_-768x768.png"
                        alt="Logo Joyería" />
                    <h3 class="text-2xl font-medium text-[#166534] tracking-wide">Iniciar Sesión</h3>
                </div>
                ...
                <div class="bg-white p-8 rounded-xl shadow-sm border border-[#A1A1A1]/20 space-y-5">
                    ...
                    <div x-data="{ tipo: 'password' }">
                        <label for="password" class="block text-sm font-medium text-[#2B2B2B]">Contraseña</label>
                        <input id="password" :type="tipo" name="password" x-model="pass"
                            placeholder="••••••••" autocomplete="current-password"
                            class="mt-1 block w-full px-4 py-3 bg-white border border-[#A1A1A1]/40 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-[#D1E7DD] focus:border-[#166534]/50" />
                        <button type="button" @click="tipo = tipo === 'password' ? 'text' : 'password'"
                            class="mt-2 border border-gray-200 rounded-full hover:bg-[#D1E7DD]">
                            <span x-text="tipo === 'password' ? '👀' : '🙈'">
                            </span>
                        </button>
                    ...
                    <div>
                        <button type="submit"
                            class="w-full bg-[#166534] hover:bg-[#0e4a24] text-white py-3 rounded-lg text-sm font-medium tracking-wide transition duration-200 shadow-md hover:shadow-lg">
                            Acceder
                        </button>
                    </div>
                </div>
