<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex items-center">
                    ...
                    <x-dropdown>
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-white hover:text-gray-500 focus:outline-none focus:text-gray-700 focus:border-indigo-700 transition ease-in-out duration-150">
                                Usuarios
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('usuarios.create')" :active="request()->routeIs('usuarios.create')">
                                Registrar Usuario
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    ...
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('categorias.create')" :active="request()->routeIs('categorias.create')">
                                Registrar Categoria
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('proveedores.index')" :active="request()->routeIs('categorias.index')">
                                Lista de Proveedores
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('proveedores.create')" :active="request()->routeIs('categorias.create')">
                                Registrar Proveedor
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
                    <x-dropdown>
                        ...
                        <x-slot name="content">
                            ...
                            <x-dropdown-link :href="route('productos.create')" :active="request()->routeIs('productos.create')">
                                Registrar Producto
                            </x-dropdown-link>
                        </x-slot>
                    </x-dropdown>
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('categorias.create')" :active="request()->routeIs('categorias.create')">
            ...
            <x-responsive-nav-link :href="route('proveedores.create')" :active="request()->routeIs('proveedores.create')">
