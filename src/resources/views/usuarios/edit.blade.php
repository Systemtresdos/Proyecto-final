                    ...
                    <form action="{{ route('usuarios.update', $user) }}" method="POST" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="apellido_p" id="apellido_p" value="{{ old('apellido_p', $user->apellido_p) }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500" required>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="apellido_m" id="apellido_m" value="{{ old('apellido_m', $user->apellido_m) }}"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="usuario" id="usuario" value="{{ old('usuario', $user->usuario) }}"
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-emerald-500 focus:border-emerald-500" required>
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <select name="estado" id="estado"
                                    ...
                                    <option value="Bloqueado" @selected(old('estado', $user->estado) == 'Bloqueado')>Bloqueado</option>
                                </select>
                            </div>
