            ...
            <div class="bg-white rounded-xl shadow-md overflow-hidden transition-all duration-300 hover:shadow-lg">
                ...
                <div class="p-6 bg-gradient-to-r from-[#D1E7DD] to-[#D1E7DD]/70 border-b border-[#D1E7DD]">
                    <div class="flex items-center space-x-3">
                        <div>
                            <h3 class="text-2xl font-bold text-[#2B2B2B]">Editar Producto</h3>
                            <p class="text-sm text-[#A1A1A1] mt-1">Editando: <span
                                    class="font-medium text-[#166534]">{{ $productos->nombre }}</span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="p-6 md:p-8">
                    <form action="{{ route('productos.update', $productos->id) }}" method="POST"
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <!-- Nombre -->
                            <div>
                                <label for="nombre" class="block text-sm font-medium text-[#2B2B2B] mb-1">Nombre <span
                            ...
                            <!-- Código -->
                            <div>
                                <label for="codigo" class="block text-sm font-medium text-[#2B2B2B] mb-1">Código <span
                                        class="text-red-500">*</span></label>
                                <input type="text" name="codigo" id="codigo" required
                                    class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534] transition duration-200"
                                    value="{{ old('codigo', $productos->codigo) }}">
                            </div>
                            ...
                            <!-- Stock -->
                            <div>
                                <label for="stock" class="block text-sm font-medium text-[#2B2B2B] mb-1">Stock <span
                                        class="text-red-500">*</span></label>
                            ...
                            <div class="md:col-start-3">
                                ...
                                <input type="number" step="0.01" name="precio_venta" id="precio_venta" required
                                    class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534] transition duration-200"
                                    value="{{ old('precio_venta', $productos->precio_venta) }}">
                            </div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <textarea name="descripcion" id="descripcion" rows="3"
                                    class="w-full px-4 py-3 border border-[#A1A1A1]/30 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-[#166534]/50 focus:border-[#166534] transition duration-200">{{ old('descripcion', $productos->descripcion) }}</textarea>
                            </div>
                            <div>
                                <label for="imagen"
                                    class="block text-sm font-medium text-[#2B2B2B] mb-1">Imagen</label>
                                <div class="flex items-center space-x-4">
                                    @if ($productos->imagen)
                                        <div class="flex flex-col items-center">
                                            <img src="{{ asset($productos->imagen) }}" alt="Imagen actual"
                                                class="h-32 w-32 rounded-lg border border-[#A1A1A1]/30 object-cover">
                                        </div>
                                    @endif
                                </div>
                                <div class="flex flex-col items-start space-y-4">
                                    <input type="file" name="imagen" id="imagen" accept="image/*"
                                        ...
                                        class="block w-full text-sm text-[#2B2B2B] file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-medium file:bg-[#D1E7DD] file:text-[#166534] hover:file:bg-[#D1E7DD]/80">
                                </div>
                            </div>
                        </div>
                        <!-- Botones -->
